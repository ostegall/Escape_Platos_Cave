...
int main()
{
    printf(" _______  _______  _______  _______  _______  _______  _____         _______  _        _______ _________ _______  _  _______        _______  _______           _______  \n");
    ...
    //Wait for input (if not an int, game crashes)
    do {                           
        scanf("%c", &start);
    } while (start != '1');
    ...
    sleep(1);
    printf("You wake where you usually do: in complete darkness, unable to move your head.\n");

    sleep(5);
    printf("After some time, the wall in front of you is illuminated by light.\n");

    sleep(5);
    printf("You see a shadow on the wall\n");
    ...
    do {
        ...
        if (shadow == 0) {
            ...
            printf("MMMWNWMMMWWWWMMMWWWWMMMWWWWMMWWWWMMMWWWWMMMWNWMMMWWWWMMMWNNNWMWWWWMMMWWWWMMMMWWWWMMMWNWWMMWWWWMMMWWWWMMWWWWWMMWWWWMMMWWWWMMMWNWMMMWWWWMMMWWWWMMWWWWWMM\n");
            ...
            printf("MMMMMMMMMWNWNNNNNWWMMMMMMMMWWNNNNNNNWMMMMMMMMMWWNNNNWWWWMMMMMMMMMWNNWNKkolllldOXMMMMWWNWNNNNWWWMMMMMMMMWWNNNNNNNWMMMMMMMMMWWWNNWWNWWMMMMMMMMMWNNNNNNNN\n");
        ...
        if (count >= 3 && shadow % 2 == 0) {
            sleep(3);
            printf("You notice a key on the floor next to you.\n");
            sleep(3);
                printf("NNNWMMWNNNWMMWWNNWWMWWNNNWWMWNNNWMMWNNNWWMMWNNNWMMWNNNWWWWWNWWWMWWNNNWWMWNNNNWMMWWNNWMMMWNNNWMMWNNNWMMWNNNWWMWWNNNWMMWNNNWMMWNNNWWMWWNNWWMMWNNNWMMWNNN\n");
            ...
            sleep(3);
            printf("Do you take it? (Y == 0, N == 1): ");
            while (key_response == -1) {
                scanf("%d", &key_response);
            }
            if (key_response == 0) {
                key = 1;
                printf("What could this key possibly be for?\n");
                sleep(3);
            } else {
                key = 0;
                printf("You ignore the key...it has no use for you\n");
                sleep(3);
                printf("Plato: 'If they could engage in discussion with one another, don’t you think they would assume that the words they used applied to the things they see passing in front of them?'\n");
                sleep(5);
                printf("You would rather be praised for looking at shadows.\n");
                sleep(3);
                printf("Plato: 'There had been honors, praises, or prizes among them for the one who was sharpest at identifying the shadows as they passed by'\n");
                sleep(5);
            }
            key_response = -1;
        }
    ...
    if (count == 7) {
        ...
        sleep(3);
        printf("Plato: 'What the prisoners would take for true reality is nothing other than the shadows of those artifacts.'\n");
        sleep(5);
        printf("There may be more to your existence outside of these shadows\n");
        sleep(3);
    }
    if (key != 1) {
        printf("ERROR: Incorrect input");
        sleep(3);
        printf("Restart Game and Try Again");
        sleep(3);
        return EXIT_SUCCESS; 
    }

    int leave_response = -1;
    printf("You see that the key can unlock your chains.\n");
    sleep(5);
    printf("Do you wish to leave now (0) or wait to leave (1)? \n");
    while (leave_response == -1) {
        scanf("%d", &leave_response);
    }
    if (leave_response == 0) {
        printf("You use the key to break out of your chains while the shadows are still on the wall.\n");
        sleep(3);
        printf("You stand up, turn around, and see nothing but bright light.\n");
        sleep(3);
        printf("Plato: 'When one was freed and suddenly compelled to stand up, turn his neck around, walk, and look up toward the light, he would be pained'\n");
        sleep(5);
        printf("When your sight returns from the bright light, you see more of your surroundings, but don't understand them.\n");
        sleep(3);
        printf("Plato: 'He would be puzzled and believe that the things he saw earlier were more truly real than the ones he was being shown'\n");
        sleep(5);
        printf("Guards in the cave pull you to your chains and lock you back up to look at shadows.\n");
        sleep(3);
        printf("Your eyes stay dark.\n");
        sleep(3);
        printf("You have lost...this time. Try again to learn more about what life truly is.\n");
        return EXIT_SUCCESS;
    } else if (leave_response == 1) {
        printf("You decide to wait until the shadows are gone, fearing what could be from behind.\n");
        sleep(3);
        printf("After the shadows stop passing by, you unlock your chains, stand up, and turn around.\n");
        sleep(5);
        printf("You turn around and see a big bright light shining, hurting your eyes.\n");
        sleep(3);
        printf("Plato: 'When one was freed and suddenly compelled to stand up, turn his neck around, walk, and look up toward the light, he would be pained'\n");
        sleep(7);
        printf("*You have gained awareness of light.*\n");
        sleep(3);
        printf("After your eyes adjust, you notice more of the cave around you.\n");
        sleep(5);
        printf("Plato: 'What he had seen before was silly nonsense, but that now — because he is a bit closer to what is, and is turned toward things that are more — he sees more correctly'\n");
        sleep(9);
        printf("*You have gained awareness of the real world.*\n");
        sleep(5);
        printf("You look up and notice a big, bright hole above your head.\n");
        sleep(3);
    } else {
        printf("ERROR: Incorrect input");
        sleep(3);
    ...
    printf("As you stare up into this bright, mysterious hole, some unknown entity pulls you up into it and out of the cave.\n");
    sleep(3);
    printf("Plato: 'Someone dragged him by force away from there, along the rough, steep, upward path, and did not let him go until he had dragged him into the light of the sun'\n");
    sleep(5);
    printf("Once you reach the above-ground, you try to figure out all of these new, even brighter surroundings.\n");
    sleep(3);
    printf("You look to your left and see human-shaped shadows moving all over in a busy area.\n");
    sleep(3);
    printf("You also see a stationary shadow floating to your right, in the shape of a boat.\n");
    sleep(3);
    int interact_response = -1;
    printf("Which shadow do you want to identify first? Human == 0, Boat == 1\n");
    sleep(3);
    while (interact_response == -1) {
        scanf("%d", &interact_response);
    }
    if (interact_response == 0) {
        printf("You run right up to the human shadow, point at it, and say 'Human'.\n");
        sleep(3);
        printf("Plato: 'At first, he would see shadows most easily'\n");
        sleep(3);
        printf("Confusingly, no one gives you praise and honor for pointing this out.\n");
        sleep(5);
        printf("Instead, the person whose shadow you just pointed at looks at you and asks what is wrong with you.\n");
        sleep(5);
        printf("Plato: 'When [someone] saw a soul disturbed and unable to see something, he would not laugh absurdly. Instead, he would see whether it had come from a brighter life and was dimmed through not having yet become accustomed to the dark, or from greater ignorance into greater light and was dazzled by the increased brilliance. Then he would consider the first soul happy in its experience and life, and pity the latter.'\n");
        sleep(13);
        printf("You feel shame for being laughed at and descend back into the cave to continue pointing at shadows.\n");
        sleep(3);
        printf("Maybe try a different direction...check Plato's 'Allegory of the Cave' to see where the escaped prisoner should look first.\n");
        sleep(5);
        return EXIT_SUCCESS;
    } else if (interact_response == 1) {
        printf("You run right up to the boat shadow, point at it, and say 'Boat'.\n");
        sleep(3);
        printf("Plato: 'At first, he would see shadows most easily'\n");
        sleep(3);
        printf("Confusingly, no one gives you praise and honor for pointing this out.\n");
        sleep(3);
        printf("The person who has dragged you out of the hole, The Teacher, walks over and tells you that the shadow is of a boat, but that there may be more to see.\n");
        sleep(5);
        printf("The Teacher asks you where you want to look next.\n");
        sleep(3);
    } else {
        printf("ERROR: Incorrect input");
        sleep(3);
    ...
    int next = 1;
    while(new_count != 4) {
        printf("Where do you want to look next?\n");
        printf("1) Objects\n");
        printf("2) Sun\n");
        printf("3) Sky\n");
        ...
        if (next == 1 && guess == 4) {
            printf("You gaze into the water near the boat's shadow.\n");
            sleep(3);
            printf("You see another version of yourself looking back.\n");
            sleep(3);
            printf("You also see a reflection of the boat in the water.\n");
            sleep(3);            
            printf("MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMWWWWNNNNNWWWMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM\n");
            ...
            sleep(3);
            printf("Plato: 'Then [he sees] images of men and other things in water'\n");
            sleep(3);
            printf("*You have gained awareness of reflections.*\n");
            sleep(3);
            next++;
            new_count++;
        } else if (next == 2 && guess == 1) {
            printf("You look up from the water and see the boat itself, rocking on the lapping waves.\n");
            sleep(5);
            printf("MMMNXXNWMMWNXXWMMMNXXNWMMWNXXWMMMNXXNWMMWNXXWMMMNXXNWMMWNXXWMMMNXXNWMMWNXXWMMMMNXXNWMMWNXXWMMMNXXNWMMWNXXWMMMNXXNWMMWNXXWMMMNXXNWMMWNXXWMMMNXXNWMMWNXX\n");
            ...
            sleep(3);
            printf("Plato: 'Then [he sees] the things themselves.'\n");
            sleep(3);
            printf("*You have gained awareness of objects*\n");
            sleep(3);
            next++;
            new_count++;
        } else if (next == 3 && guess == 3) {
            printf("You look up even further from the boat and see the blue sky with clouds all around.\n");
            sleep(3);
            printf("XNNNNXXXNNNNNXXXNNNNXXXNNNNNXXXNWNNXXXNNNNNXXXNNWNXXXNNNNXXXXNNWNXXXNNNNNXXXXNWNNXXXNNNNNXXXNNNNXXXNNNNNXXXNWWNXXXNNWNNXXXNNWNXXXNNNNNXXXNNNNXXXXNWNXX\n");
            ...
            sleep(3);
            printf("You stare at blue sky until it turns dark, revealing the easily visible stars and moon.\n");
            sleep(7);
            printf("MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMWNK0kdoc:;'....              ....';:loxOKNWMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM\n");
            ...
            sleep(3);
            printf("Plato: 'It would be easier for him to go on to look at the things in the sky and the sky itself at night, gazing at the light of the stars and the moon, than during the day, gazing at the sun and the light of the sun.'\n");
            sleep(7);
            printf("*You have gained awareness of the sky, moon, and stars*\n");
            sleep(3);
            next++;
            new_count++;
        } else if (next == 4 && guess == 2) {
            printf("You continue staring up above at the sky until it turns to day again, finding the blue sky and clouds once more.\n");
            sleep(3);
            printf("You look to the horizon and see the sun, rising over the ocean right in front of you.\n");
            sleep(3);
            printf("WWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWW\n");
            ...
            sleep(3);
            printf("Plato: 'Finally, I suppose, he would be able to see the sun'\n");
            sleep(3);
            printf("*You have gained awareness of the sun.*\n");
            sleep(3);
            next++;
            new_count++;
        } else {
            printf("You can't look at that right now; you're trying to grow accustomed to all of the light in this new surrounding.\n");
            sleep(3);
            printf("Plato: 'He would need time to get adjusted, I suppose, if he is going to see the things in the world above.'\n");
            sleep(5);
            printf("Try again. Maybe read Plato's 'Allegory of the Cave' to find the right order.\n");
            sleep(3);
        }
    }

    printf("You have grown accustomed to the lights outside of the cave, with your eyes open to see reality.\n");
    sleep(3);
    printf("You think back to your earlier life in the cave, and feel overjoyed for being free in this new world.\n");
    sleep(3);
    printf("Plato: 'What about when he reminds himself of his first dwelling place, what passed for wisdom there, and his fellow prisoners? Don’t you think he would count himself happy for the change and pity the others?'\n");
    sleep(5);
    printf("Do you think you should return to the cave and possibly help the other cave-dwellers see the light? Or should you stay above and revel in this new reality?\n");
    sleep(5);
    printf("Return == 0, Stay == 1\n");
    sleep(3);
    int return_decision = -1;
    while (return_decision == -1) {
        scanf("%d", &return_decision);
    }

    if (return_decision == 0) {

        printf("You make your way back down into the cave, unable to see after being exposed to so much brightness.\n");
        sleep(3);
        printf("Plato: 'If this man went back down into the cave and sat down in his same seat, wouldn’t his eyes be filled with darkness, coming suddenly out of the sun like that.'\n");
        sleep(7);
        printf("You try to continue playing in the shadow-guessing game once more.\n");
        sleep(3);

        printf("MMMMMMMMMMMMMMMMMMMMWWWWWWWWWWWWWWWWWWWWWNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNWWWWWWWWWWWMMMMMMMMMMMMMMMMMMM\n");
        ...
        printf("MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM\n");
        sleep(3);
        printf("You are unable to see any sort of shapes in these shadows, so the other priosners laugh at you.\n");
        sleep(3);
        printf("Plato: 'If he had to compete once again with the perpetual prisoners in recognizing the shadows, while his sight was still dim and before his eyes had recovered, and if the time required for readjustment was not short, wouldn’t he provoke ridicule?'\n");
        sleep(9);
        printf("The prisoners mock your ascent and claim that you've lost the capability to see reality, as this is the only reality they have ever known.\n");
        sleep(7);
        printf("Plato: 'Wouldn’t it be said of him that he had returned from his upward journey with his eyes ruined, and that it is not worthwhile even to try to travel upward'\n");
        sleep(7);
        printf("This return feels pointless at first.\n");
        sleep(5);
        printf("However, as your eyes adjust once more to this already-experienced darkness, you realize your ability to assist others in the cave in seeing the real world, as you have been in both this false reality as well as the real world.\n");
        sleep(9);
        printf("You begin to tell stories of what life is like up above, getting the attention of your fellow prisoners.\n");
        sleep(7);
        printf("*You have successfully gained awareness of being a philosopher*.\n");
        sleep(5);
        printf("Congratulations! You now understand Plato's Allegory of the Cave! You win!!!\n");
        sleep(5);
        printf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");

    } else if (return_decision == 1) {  

            printf("You decide to stay up above and disregard your fellow prisoners. This reality is yours to take in, and yours alone.\n");
            sleep(5);
            printf("Plato: 'Ones who get to this point are not willing to occupy themselves with human affairs, but that, on the contrary, their souls are always eager to spend their time above'\n");
            sleep(5);
            printf("Perhaps reconsider why you should return to the cave.\n");
            sleep(5);
            printf("Plato: 'We must not allow them to...stay there and refuse to go down again to the prisoners in the cave and share their labors and honor'\n");
            sleep(3);
            printf("Try again.\n");
            sleep(3);
            return EXIT_SUCCESS;
    ...
    printf("Epilogue:\n");
    sleep(3);
    printf("The Allegory of the Cave is a metaphor for education in Plato's mind.\n");
    sleep(5);
    printf("As you ascend, whether on your own or with the help of another, you learn more about 'true reality' to find the good in life. Therefore, you begin to learn.\n");
    sleep(7);
    printf("Plato: 'It is our task...to compel the best natures to learn what was said before to be the most important thing: namely, to see the good; to ascend that ascent.'\n");
    sleep(7);
    printf("The perfect city Plato envisions, through Socrates, will have philosophers that he has helped 'ascend' through education.\n");
    sleep(7);
    printf("Plato: 'We have bred you to be leaders and kings in the hive, so to speak. You are better and more completely educated than the others, and better able to share in both types of life.'\n");
    sleep(7);
    printf("After ascending out of the cave and into the real world (a.k.a to learn), you must then go back down to the cave and return to your former being in human affairs.\n");
    sleep(7);
    printf("Your prior experience in the 'darkness' will come in handy as you are able to relate the true good to your fellow 'prisoners'.\n");
    sleep(7);
    printf("Plato: 'Each of you in turn must go down to live in the common dwelling place of the other citizens and grow accustomed to seeing in the dark'.\n");
    sleep(7);
    printf("Plato's Allegory of the Cave is a metaphor for a new type of education, ruled by philosophers who introduce goodness to their citizens instead of worrying about trivial things such as power.\n");
    sleep(7);
    printf("Plato: So the city will be awake, governed by us and by you; not dreaming like the majority of cities nowadays, governed by men who fight against one another over shadows and form factions in order to rule.\n");
    sleep(7);
    // printf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    // sleep(3);
    printf("THE END\n");
...
//he would rather suffer anything than entertain these false notions and live in this miserable manner.
...
// int tries = 0;
    ...
    printf("What's your choice? (0 = rock, 1 = paper, 2 = scissors) ");
    scanf("%d", &choice);

    printf("I'm randomly choosing");
        printf(".");
        printf(".");
        printf(".\n");
    // }      
    ...
    if (secret == choice) {
        printf("Tie game! Want to try again? (y/n) ");
        scanf(" %c", &response);
    }

    if (secret == 0) {
        if (choice == 1) {
            printf("I lost with rock against paper. Want to play again? (y/n) ");
            scanf(" %c", &response);
        }
        if (choice == 2) {
            printf("I won with rock against scissors. Want to try again? (y/n) ");
            scanf(" %c", &response);
        }
    }
    ...
    if (secret == 1) {
        if (choice == 0) {
            printf("I won with paper against rock. Want to try again? (y/n) ");
            scanf(" %c", &response);
        }
        if (choice == 2) {
            printf("I lost with paper against scissors. Want to play again? (y/n) ");
            scanf(" %c", &response);
        }
    }
    ...
    if (secret == 2) {
        if (choice == 0) {
            printf("I lost with scissors against rock. Want to play again? (y/n) ");
            scanf(" %c", &response);
        }
        if (choice == 1) {
            printf("I won with scissors against paper. Want to play again? (y/n) ");
            scanf(" %c", &response);
        }
    }
